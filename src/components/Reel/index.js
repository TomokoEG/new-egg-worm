			...
			<section id="gl-statement">
				<div className="gl-state-copyset">
					<div className="gl-state-copy">
						<img src="https://raw.githubusercontent.com/kunsansang/new-egg-worm/main/src/components/Reel/eggwormLine.svg" alt="logo"></img>
					</div>
				</div>
				<div className="gl-state-copyset">
					<div className="gl-state-copy">
						<img src="https://raw.githubusercontent.com/kunsansang/new-egg-worm/main/src/components/Reel/eggworm.svg" alt="logo"></img>
					</div>
				</div>
				<div className="gl-state-white"></div>
				<div className="gl-statement-txt">
					<p className="gl-state-intxt large">
